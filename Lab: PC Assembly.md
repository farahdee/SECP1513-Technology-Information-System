...
## Summary
- Watched the lecturer demonstrate the complete process of assembling and disassembling a PC
- Practiced handling, removing, and installing hardware components carefully and correctly
...
During the session, my group of six had to work together to disassemble and reassemble the PC. We took turns handling different components, checking connections, and making sure everything was placed correctly so that the system could boot successfully after reassembly. Seeing the concepts we usually learn from slides come to life in front of us made the learning experience so much more engaging.

Through this hands-on activity, I realised that I enjoy physically examining, removing, and installing each part because it helps me fully understand how everything fits together to form a functional system. The session also helped me improve my teamwork, communication, and patience—especially when sharing tools and coordinating tasks with my group members. I noticed myself becoming more confident and comfortable when dealing with hardware.
