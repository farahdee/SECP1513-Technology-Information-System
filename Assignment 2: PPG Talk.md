...
This industry talk was presented by PPG, a global leader known for protecting and enhancing surfaces around the world. Their worldwide operations are supported by the Digital IT teams at the MY Technology Centre. The session focused on three major pillars that form the core of PPG’s digital ecosystem:
- SAP Centre of Excellence (CoE):
  
  Responsible for unifying global business processes through the implementation of the S/4HANA ERP platform.
- IT Infrastructure & Vendor Management:
  
  Ensures a secure, scalable, and reliable digital environment, especially in areas such as cloud architecture and WAN/LAN connectivity.
